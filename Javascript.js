...
function scrol(){
  var x = document.getElementById("timcon");
  x.scrollTop+=10
}
    setTimeout("scrol()", 10000);
    setInterval ("scrol()", 500);
...
function linux8(){
  document.getElementById("ti").innerHTML = "video Linux 8";
  document.getElementById("vid_frame").src="https://youtube.com/embed/cOSEOYi9JS4?autoplay=1&rel=0&controls=1";
}
...
function html1(){
  document.getElementById("ti").innerHTML = "HTML Introduction Part 1";
  document.getElementById("vid_frame").src="https://youtu.be/lCbLb0L91oY";}
function html2(){
  document.getElementById("ti").innerHTML = "HTML Introduction Part 2";
  document.getElementById("vid_frame").src="https://youtu.be/B9jrTFlamcU";
}
function html3(){
  document.getElementById("ti").innerHTML = "CSS Fundamentals";
  document.getElementById("vid_frame").src="https://youtu.be/h6s9gV13N9w";
}
